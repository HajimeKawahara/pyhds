...
if __name__ == "__main__":
    ...
    parser.add_argument('-r', help='unique header for -t option', action='store_true')
        ...
        if args.t:
            ...
            if un != unp  and args.r:
                ...
                if args.s:
                    if i==1:
                        print "-------------"
                        print "List: ",  filep.replace(".fits","").replace("q","").replace("v",""),
                    print file.replace(".fits","").replace("q","").replace("v",""),
                else:
                    print ".",
